...
class TimerQueue {
 ...
 private:
  ...
  // Timers are generally sparse, so sleeping until a timer is queued or due is
  // substantially cheaper than continuously yielding a CPU core. Publishing a
  // ring-buffer slot signals this strategy, preserving prompt timer wakeups.
